...
public class toClickOnallTExtBoxes {
	...
	public static void main(String[] args) {
		...
		List<WebElement> checks = driver.findElements(By.xpath("//*[contains(@id,'ohrmList_chkSelectRecord_')]"));
		for(WebElement chekeboxs:checks) {
			chekeboxs.click();
